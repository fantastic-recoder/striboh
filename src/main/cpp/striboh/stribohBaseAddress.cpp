...
namespace striboh::base {
    ...
    namespace url {
        ...
        struct action<Http> {
            ...
            static void apply(const ActionInput & /*pIn*/, Address &pAddress) {
                pAddress.setProtocol(EProtocol::HTTP);
            }
        };
        ...
        struct action<Shm> {
            template<typename ActionInput>
            static void apply(const ActionInput & /*pIn*/, Address &pAddress) {
                pAddress.setProtocol(EProtocol::SHM);
            }
        };
    ...
    std::string Address::str() const {
        std::string myRetVal;
        if (getProtocol() == EProtocol::HTTP) {
            myRetVal += "http";
        } else if (getProtocol() == EProtocol::SHM) {
            myRetVal += "shm";
        } else {
            myRetVal += "none";
        }
